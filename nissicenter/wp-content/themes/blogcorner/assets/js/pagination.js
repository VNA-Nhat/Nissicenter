...
let loadButtonWrapper = document.querySelector(".blogcorner-load-posts-btn-wrapper");
let loadButton = document.querySelector(
    ".blogcorner-load-posts-btn-wrapper .load-btn"
);
let loader = document.querySelector(".blogcorner-ajax-loader");
let articleWrapper = document.querySelector(".blogcorner-article-wrapper");
    ...
    fetchThePosts: function () {
        ...
        fetch(BlogcornerVars.ajaxurl, {
            ...
            body: new URLSearchParams({
                action: "blogcorner_load_posts",
                nonce: BlogcornerVars.nonce,
                query_vars: BlogcornerVars.query_vars,
                page: nextPage,
            }),
        })
            .then((response) => {
