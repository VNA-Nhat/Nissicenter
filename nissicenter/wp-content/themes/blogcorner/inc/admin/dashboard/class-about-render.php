 ...
 */
class Blogcorner_Theme_Dashboard
{
    ...
    public $settings = array(
        'tabs' => array(),
        'demo_link' => 'https://live-preview.themeinwp.net/blogcorner',
    ...
    public function __construct()
    {
        ...
        add_action('wp_ajax_blogcorner_dismissed_handler', array($this, 'dismissed_handler'));
        ...
        if( isset( $_GET['page'] ) && $_GET['page'] == 'theme-dashboard' ){
            ...
            add_action('in_admin_header', array( $this,'blogcorner_hide_all_admin_notice' ),1000 );

        }
    }


    public function blogcorner_hide_all_admin_notice(){
    ...
    {
        add_submenu_page('themes.php', esc_html__('Blogcorner Dashboard', 'blogcorner'), esc_html__('Theme Dashboard', 'blogcorner'), 'manage_options', $this->menu_slug, array($this, 'html_carcase'), 1);
    }
    ...
    {
        wp_enqueue_script('blogcorner', get_template_directory_uri() . '/inc/admin/dashboard/js/scripts.js', array('jquery'), filemtime(get_template_directory() . '/inc/admin/dashboard/js/scripts.js'), true);
        $ajax_dismiss_notice_nonce = wp_create_nonce('blogcorner_dismiss_notice_nonce');
        wp_localize_script('blogcorner', 'blogcorner_localize', array(
            'ajax_url' => admin_url('admin-ajax.php'),
            'nonce' => wp_create_nonce('nonce'),
            'dismiss_notice_nonce' => $ajax_dismiss_notice_nonce,
            'upload_image'   =>  esc_html__('Choose Image','blogcorner'),
            'use_image'   =>  esc_html__('Select','blogcorner'),
            'active' => esc_html__('Active','blogcorner'),
            'deactivate' => esc_html__('Deactivate','blogcorner'),
            'failed_message' => esc_html__('Something went wrong, contact support.', 'blogcorner'),
        ));

        // Styles.
        wp_enqueue_style('blogcorner', get_template_directory_uri() . '/inc/admin/dashboard/css/style.css', array(), filemtime(get_template_directory() . '/inc/admin/dashboard/css/style.css'));

        // Add RTL support.
        wp_style_add_data('blogcorner', 'rtl', 'replace');
    }
                    ...
                    <div class="dashboard-feature-row dashboard-feature-row-bottom">
                        ...
                        if (isset($feature['activate_uri']) && $feature['activate_uri']) {
                            ...
                            <a href="<?php echo esc_attr($customize_uri); ?>" class="dashboard-feature-item-customize"
                               target="_blank">
                                <?php esc_html_e('Customize', 'blogcorner'); ?>
                            </a>
                        <?php } ?>
                    </div>
                </div>
        ...
        <div class="suggested-enhancement">
                ...
                <div class="suggested-enhancement-panel">
                    ...
                    <div class="suggested-enhancement-content">
                        <div class="suggested-enhancement-title">
                            <?php esc_html_e('Fastest WordPress Hosts', 'blogcorner'); ?>
                        </div>

                        <div class="suggested-enhancement-description">
                            <?php esc_html_e('A slow host can really put a drag on your site’s performance, even an optimized one. Make sure you get a host that won’t hold you back by reading our review, complete with real speed tests, of the fastest WordPress hosts. ', 'blogcorner'); ?>
                        </div>

                        <a class="suggested-enhancement-link" href="<?php echo esc_url($this->settings['insights_link_1']); ?>" target="_blank">
                            <?php esc_html_e('Read more', 'blogcorner'); ?>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="suggested-enhancement-item suggested-enhancement-item-half">
                <div class="suggested-enhancement-panel">
                    ...
                    <div class="suggested-enhancement-content">
                        <div class="suggested-enhancement-title">
                            <?php esc_html_e('WP Rocket Review', 'blogcorner'); ?>
                        </div>

                        <div class="suggested-enhancement-description">
                            <?php esc_html_e('Every site that is serious about speed (and should be pretty much all sites these days) needs a caching plugin and WP Rocket is our pick of the bunch. Get the lowdown on why we recommend it n our data-backed review: ', 'blogcorner'); ?>
                        </div>
            ...
            <div class="suggested-enhancement-item suggested-enhancement-item-half">
                <div class="suggested-enhancement-panel">
                    ...
                    <div class="suggested-enhancement-content">
                        <div class="suggested-enhancement-title">
                            <?php esc_html_e('Best WordPress Speed Optimization Plugins', 'blogcorner'); ?>
                        </div>

                        <div class="suggested-enhancement-description">
                            <?php esc_html_e('We run through the top 10 WordPress performance plugins to keep your site running fast. Goes beyond just caching plugins (though those are on there too!). A must-read for all WordPress site owners.', 'blogcorner'); ?>
                        </div>
        ...
        <div class="dashboard-hero-panel">
            <div class="hero-panel-content">
                <div class="hero-panel-subtitle">
                    <?php esc_html_e('Hello, ', 'blogcorner'); ?>
                ...
                <div class="theme-admin-button-wrap theme-admin-button-group">
                    ...
                    <?php if ('themes.php' === $pagenow && 'themes' === $screen->base) { ?>
                        <a href="<?php echo esc_url(add_query_arg('page', $this->menu_slug, admin_url('themes.php'))); ?>" class="button theme-admin-button admin-button-primary">
                            ...
                            <span><?php esc_html_e('Theme Dashboard', 'blogcorner'); ?></span>
                        </a>
                    <?php } ?>
                    ...
                    <a href="<?php echo esc_url($this->settings['demo_link']); ?>" class="button theme-admin-button admin-button-secondary" target="_blank">
                        ...
                        <span><?php esc_html_e('View Live Demo', 'blogcorner'); ?></span>
                    </a>
                    ...
                    <a href="<?php echo esc_url($this->settings['documentation_link']); ?>" class="button theme-admin-button admin-button-secondary" target="_blank">
                        ...
                        <span><?php esc_html_e('Theme Documentation', 'blogcorner'); ?></span>
                    </a>
                </div>
                    ...
                    <div class="dashboard-header-panel">
                        <div class="dashboard-masthead-item dashboard-masthead-left">
                            <a href="<?php echo esc_url('https://themeinwp.com/'); ?>" class="theme-author-logo" target="_blank">
                                <img src="<?php echo esc_url(get_template_directory_uri() . '/inc/admin/dashboard/images/blogcorner-logo.png'); ?>" alt="<?php esc_attr_e('ThemeinWP', 'blogcorner'); ?>">
                            </a>
                        </div>
                        ...
                        <div class="dashboard-masthead-item dashboard-masthead-right">
                            <a href="<?php echo esc_url($this->settings['documentation_link']); ?>" class="button theme-button-small theme-admin-button admin-button-secondary" target="_blank">
                                <span><?php esc_html_e('Documentation', 'blogcorner'); ?></span>
                        ...
                        <div class="dashboard-hero-main-sidebar">
                            ...
                            <div class="theme-dashboard-panel dashboard-panel-review">
                                <div class="dashboard-panel-head">
                                    <h3 class="dashboard-panel-title"><?php esc_html_e('Review', 'blogcorner'); ?></h3>
                                </div>
                                <div class="dashboard-panel-content">
                                    ...
                                    <div class="theme-admin-description"><?php esc_html_e('It makes us happy to hear from our users. We would appreciate a review.', 'blogcorner'); ?></div>

                                    <div class="theme-admin-button-wrap">
                                        <a href="<?php echo esc_url($this->settings['review_link']); ?>"
                                           class="theme-admin-button button" target="_blank">
                                            <?php esc_html_e('Submit a Review', 'blogcorner'); ?>
                                        </a>
                                    </div>

                                    <div class="theme-admin-separator"></div>

                                    <div class="theme-admin-title"><?php esc_html_e('Have an idea or feedback?', 'blogcorner'); ?></div>

                                    <div class="theme-admin-description">
                                        <?php esc_html_e('If you have any suggestions or comments about our WordPress theme, please let us know. We value your feedback and strive to continuously improve our product.', 'blogcorner'); ?>
                                    </div>

                                    <a href="<?php echo esc_url($this->settings['suggest_idea_link']); ?>" class="theme-feature-request" target="_blank">
                                        <?php esc_html_e('Suggest an Idea', 'blogcorner'); ?>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="theme-dashboard-panel dashboard-panel-changelog">
                                <div class="dashboard-panel-head">
                                    <h3 class="dashboard-panel-title">
                                        <?php esc_html_e('Changelog', 'blogcorner'); ?>
                                    </h3>
                                ...
                                <div class="dashboard-panel-content">
                                    <div class="theme-admin-description"><?php esc_html_e('The theme changelog provides a brief history of updates and modifications made to the theme. Keep informed with the changes and improvements that have been made over time.', 'blogcorner'); ?></div>

                                    <a href="<?php echo esc_url($this->settings['changelog_link']); ?>"
                                       class="theme-changelog-info" target="_blank">
                                        <?php esc_html_e('See the Changelog', 'blogcorner'); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="dashboard-wrapper">
                    <div class="dashboard-footer-panel">
                        <div class="theme-dashboard-panel dashboard-panel-support">
                            <div class="dashboard-panel-head">
                                <h3 class="dashboard-panel-title"><?php esc_html_e('Support', 'blogcorner'); ?></h3>

                                <?php if ($this->pro_status) { ?>
                                    <div class="theme-dashboard-badge theme-badge-primary"><?php esc_html_e('Priority Status', 'blogcorner'); ?></div>
                                <?php } ?>
                            </div>
                            <div class="dashboard-panel-content">
                                <div class="theme-dashboard-subpanel">
                                    <div class="theme-admin-title">
                                        <?php echo wp_kses_post(__('Need help? We\'re here for you!', 'blogcorner')); ?>
                                    </div>

                                    <div class="theme-admin-description"><?php esc_html_e('Do you have a question or have you encountered a bug? You can receive assistance from our amicable support team whenever you require it.', 'blogcorner'); ?></div>

                                    <div class="theme-admin-button-wrap">
                                        <a href="<?php echo esc_url($this->settings['support_link']); ?>"
                                           class="button theme-admin-button admin-button-secondary" target="_blank">
                                            <?php esc_html_e('Get Support', 'blogcorner'); ?>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <?php if (!$this->pro_status) { ?>
                                    <div class="theme-dashboard-subpanel dashboard-subpanel-bg">
                                        <div class="theme-admin-title">
                                            <?php echo wp_kses_post(__('Upgrade to priority support', 'blogcorner')); ?>

                                            <div class="theme-dashboard-badge theme-badge-secondary"><?php esc_html_e('pro', 'blogcorner'); ?></div>
                                        </div>

                                        <div class="theme-admin-description">
                                            <?php esc_html_e('Receive support via email with a prompt initial response time of 1-2 hours for all priority requests.', 'blogcorner'); ?>
                                        </div>

                                        <div class="theme-admin-button-wrap">
                                            <a href="<?php echo esc_url($this->settings['support_pro_link']); ?>"
                                               class="button theme-admin-button admin-button-primary" target="_blank">
                                                <?php esc_html_e('Get Priority Support', 'blogcorner'); ?>
                                            </a>
                                        </div>
                                    </div>
                                <?php } ?>
                        ...
                        <div class="theme-dashboard-panel dashboard-panel-community">
                            <div class="dashboard-panel-head">
                                <h3 class="dashboard-panel-title"><?php esc_html_e('Community', 'blogcorner'); ?></h3>
                            </div>
                            <div class="dashboard-panel-content">
                                <div class="theme-admin-title">
                                    <?php echo wp_kses_post(__('Join Our Community', 'blogcorner')); ?>
                                </div>

                                <div class="theme-admin-description"><?php esc_html_e('Engage with the community: talk about products, ask for help or offer assistance to the community.', 'blogcorner'); ?></div>

                                <div class="theme-admin-button-wrap">
                                    <a href="<?php echo esc_url($this->settings['community_link']); ?>"
                                       class="button theme-admin-button admin-button-tertairyx" target="_blank">
                                        <?php esc_html_e('Join Now', 'blogcorner'); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    public function notice()
    {
        ...
        if ('themes.php' === $pagenow) {
            ...
            if (!get_transient($transient_name)) {
                ...
                ?>
                <div class="notice notice-success blogcorner-primary-notice theme-admin-dashboard theme-admin-dashboard-notice is-dismissible" data-notice="<?php echo esc_attr($transient_name); ?>">
    ...
    {
        check_ajax_referer( 'blogcorner_dismiss_notice_nonce', 'security' );
...
new Blogcorner_Theme_Dashboard();
